...
function drawLabels() {
    const svgPlot = document.getElementById("svg-plot");
    ...
    for (let i = 0; i <= 10; i++) {
        ...
        if (i % 2 !== 0 && i !== 10 && i !== 5) {
            const textX = document.createElementNS(NS, "text");
            const textY = document.createElementNS(NS, "text");
...
function redrawGraph() {
    ...
    triangle.setAttribute("points", "150," + (150 + r) + " " + (150 - r) + ",150 150,150");
    let rectangle = document.getElementById("rectangle");
    rectangle.setAttribute("points", "150,150 " + (150 + r) + ",150 " + (150 + r) + "," + (150 + r / 2) + " 150," + (150 + r / 2));
    let circle = document.getElementById("circle");
    circle.setAttribute("d", "M" + (150 - r) + ",150" + " A" + r + "," + r + " 90 0,1 " + "150," + (150 - r) + " L 150,150 Z");
}
